// Standalone QUIC Transport Test
// 
// This is a minimal test for NDN over QUIC that doesn't rely
// on the existing codebase implementation
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if args.len() < 2 {
        eprintln!("Usage: quic_test [server|client] [name]");
